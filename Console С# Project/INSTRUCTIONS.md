...
## ✅ Чеклист здачі проєкту

- [ ] Програма запускається без помилок
- [ ] Всі функції працюють коректно
- [ ] Код добре структурований
- [ ] Додані коментарі до всіх класів та методів
- [ ] Реалізовані всі 12 вимог
- [ ] Створена документація (README.md)
- [ ] Підготовлена презентація
- [ ] Додана іконка до програми
- [ ] Протестовані всі сценарії
- [ ] Код відформатований та читабельний

## 🎉 Успіхів!

Цей проєкт - відмінна можливість продемонструвати ваші знання C# та .NET. 

Не бійтеся експериментувати та додавати власні ідеї!
